...
<aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white min-h-screen flex flex-col shadow-lg border-r border-gray-200 transform -translate-x-full md:translate-x-0">
    ...
    <div class="p-4 border-b">
        <div class="flex items-center space-x-3">
            <div class="w-10 h-10 rounded-full bg-teal-200 text-teal-700 flex items-center justify-center font-bold text-lg flex-shrink-0">
    ...
    <div class="p-4 border-t mt-auto">
        <form method="POST" action="{{ route('logout') }}" class="mt-4">
            ...
            <a href="{{ route('logout') }}"
               ...
               class="menu-item w-full flex justify-center py-2 border border-gray-200 rounded-lg text-gray-600 font-semibold hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors duration-200">
