            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-200">
                    <div class="sm:flex justify-between items-start mb-6">
                        ...
                        <div class="flex-shrink-0 mt-4 sm:mt-0 p-1 bg-gray-100 rounded-xl flex space-x-1">
                            <button data-tab="token" class="tab-button py-2 px-5 rounded-lg font-semibold text-sm transition-colors duration-300">
                                <i class="fa-solid fa-ticket mr-2 opacity-80"></i> Token
                            </button>
                            <button data-tab="hp" class="tab-button py-2 px-5 rounded-lg font-semibold text-sm transition-colors duration-300">
                                <i class="fa-solid fa-phone mr-2 opacity-80"></i> No. HP
                            </button>
                            <button data-tab="nama" class="tab-button py-2 px-5 rounded-lg font-semibold text-sm transition-colors duration-300">
                    ...
                    <div>
                        <form id="token" data-tab-content method="GET" action="{{ route('ticket.find') }}">
                            <label for="token_query" class="block text-sm font-medium text-gray-700 mb-2">Token Peserta</label>
                            <div class="flex">
                                <input type="text" name="token_query" id="token_query" value="{{ $search_type === 'token' ? ($query ?? '') : '' }}" placeholder="Contoh: MJE123456" class="flex-grow w-full px-4 py-3 border border-gray-300 rounded-l-lg shadow-sm focus:ring-sky-500 focus:border-sky-500 text-base">
                                <button type="submit" class="bg-gray-800 text-white font-bold py-3 px-5 rounded-r-lg hover:bg-gray-700 transition-all">
                                    <i class="fa-solid fa-search"></i>
                                </button>
                            </div>
                        ...
                        <form id="hp" data-tab-content method="GET" action="{{ route('ticket.find') }}">
                             <label for="hp_query" class="block text-sm font-medium text-gray-700 mb-2">Nomor HP</label>
                            <div class="flex">
                                <input type="tel" name="hp_query" id="hp_query" value="{{ $search_type === 'hp' ? ($query ?? '') : '' }}" placeholder="Contoh: 081234567890" class="flex-grow w-full px-4 py-3 border border-gray-300 rounded-l-lg shadow-sm focus:ring-sky-500 focus:border-sky-500 text-base">
                                <button type="submit" class="bg-gray-800 text-white font-bold py-3 px-5 rounded-r-lg hover:bg-gray-700 transition-all">
                                    <i class="fa-solid fa-search"></i>
                                </button>
                            </div>
                        ...
                        <form id="nama" data-tab-content method="GET" action="{{ route('ticket.find') }}">
                            <label for="nama_query" class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap</label>
                            <div class="flex">
                                <input type="text" name="nama_query" id="nama_query" value="{{ $search_type === 'nama' ? ($query ?? '') : '' }}" placeholder="Masukkan nama lengkap Anda..." class="flex-grow w-full px-4 py-3 border border-gray-300 rounded-l-lg shadow-sm focus:ring-sky-500 focus:border-sky-500 text-base">
                                <button type="submit" class="bg-gray-800 text-white font-bold py-3 px-5 rounded-r-lg hover:bg-gray-700 transition-all">
                                    <i class="fa-solid fa-search"></i>
