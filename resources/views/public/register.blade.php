    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <header class="flex justify-between items-center py-6 relative z-10">
            ...
            <nav class="hidden md:flex items-center space-x-6 text-gray-600">
                ...
                <a href="{{ route('event.register.form') }}" class="bg-gray-900 text-white px-5 py-3 rounded-xl font-semibold shadow-lg hover:bg-gray-800 transition-all duration-300"><i class="fa-solid fa-calendar-check mr-2"></i>Pendaftaran</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white rounded-2xl shadow-lg mt-2 absolute top-24 left-4 right-4 z-20">
            <nav class="flex flex-col p-6 space-y-5">
                ...
                <a href="{{ route('event.register.form') }}" class="text-gray-700 bg-sky-50 text-sky-600 font-semibold px-4 py-3 rounded-lg"><i class="fa-solid fa-calendar-check fa-fw mr-3"></i>Pendaftaran</a>
            ...
            <div class="max-w-3xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-xl">
                <div class="flex items-start space-x-4 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Daftarkan diri Anda untuk mengikuti Muhammadiyah Jogja Expo 2025. Pendaftaran gratis dan mendapatkan akses ke semua acara.</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('event.register.submit') }}">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Masukkan nama lengkap Anda" required autofocus class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-sky-500 focus:border-sky-500" />
                        </div>
                        <div>
                            ...
                            <textarea id="full_address" name="full_address" rows="3" placeholder="Jl. Malioboro No. 123, Yogyakarta" required class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-sky-500 focus:border-sky-500">{{ old('full_address') }}</textarea>
                        </div>
                        <div>
                            <label for="regency_select" class="block text-sm font-medium text-gray-700 mb-1">Kabupaten/Kota <span class="text-red-500">*</span></label>
                            <select id="regency_select" name="regency" required class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-sky-500 focus:border-sky-500">
                        ...
                        <div id="other_regency_wrapper" class="hidden">
                            <label for="other_regency" class="block text-sm font-medium text-gray-700 mb-1">Masukkan Nama Kabupaten/Kota Anda</label>
                            <input id="other_regency" name="other_regency" type="text" value="{{ old('other_regency') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-sky-500 focus:border-sky-500" />
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            
                            <div>
                                <label for="phone_number" class="block text-sm font-medium text-gray-700 mb-1">Nomor HP <span class="text-red-500">*</span></label>
                                <div class="relative">
                            ...
                            <div>
                                <label for="age" class="block text-sm font-medium text-gray-700 mb-1">Usia <span class="text-red-500">*</span></label>
                                <div class="relative"><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><i class="fa-solid fa-calendar text-gray-400"></i></div><input id="age" name="age" type="number" value="{{ old('age') }}" placeholder="25" required class="block w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-sky-500 focus:border-sky-500" /></div>
                            </div>
                        </div>
                        <div class="bg-blue-50 border-l-4 border-blue-400 text-blue-800 p-4 rounded-r-lg">
                            <div class="flex"><div class="py-1"><i class="fa-solid fa-circle-info"></i></div><div class="ml-3"><p class="text-sm">Setelah mendaftar, Anda akan mendapatkan <strong>token unik</strong> yang dapat digunakan untuk presensi di semua hari event dan mengikuti undian doorprize.</p></div></div>
                        </div>
                    </div>
