...
<head>
    ...
    <title>E-Ticket Anda - Muhammadiyah Jogja Expo 2025</title>
...
<body class="antialiased">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <main class="my-12">
            <div class="max-w-xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-xl">

                @if (session('success'))
                    <div class="mb-6 bg-green-50 border-l-4 border-green-400 text-green-800 p-4 rounded-lg"
                        role="alert">
                        <p class="font-bold">Pendaftaran Berhasil!</p>
                        <p>{{ session('success') }} Simpan tiket ini dengan baik.</p>
                    </div>
                @endif
                ...
                <div class="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800">E-Ticket Anda</h2>
                        <p class="text-gray-600 mt-2">Gunakan tiket ini untuk presensi dan undian doorprize.</p>
                    </div>
                </div>
                ...
                <div class="border-t pt-6 space-y-4">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-800">{{ $attendee->name }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Alamat</label>
                        <p class="text-base text-gray-700">{{ $attendee->full_address }}, {{ $attendee->regency }}</p>
                    </div>
                </div>

                <div class="text-center bg-blue-50 p-6 rounded-xl mt-8 border border-blue-200">
                    <p class="text-sm font-semibold text-blue-800 tracking-widest">NOMOR TOKEN ANDA</p>
                    <p class="text-4xl font-bold text-blue-600 my-2 tracking-wider">{{ $attendee->token }}</p>
                    <div class="flex justify-center mt-4">
                        {!! QrCode::size(200)->backgroundColor(0, 0, 0, 0)->generate($attendee->token) !!}
                    </div>
                    <p class="text-xs text-gray-500 mt-10">Tunjukkan nomor ini saat presensi di lokasi acara.</p>
                </div>

                <div class="mt-8 text-center">
                    <p class="mb-4 text-gray-600">Simpan tiket ini dengan cara screenshot atau unduh sebagai PDF.</p>
                    <a href="{{ route('ticket.download', $attendee->token) }}"
                        class="w-full md:w-auto inline-block bg-gray-900 text-white font-bold py-3 px-8 rounded-xl hover:bg-gray-700 transition-all duration-300 shadow-lg">
