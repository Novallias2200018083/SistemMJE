    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <main class="my-12">
            <div class="max-w-xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-xl">
                ...
                @if(session('success'))
                <div class="mb-6 bg-green-50 border-l-4 border-green-400 text-green-800 p-4 rounded-lg" role="alert">
                ...
                <div class="text-center bg-blue-50 p-6 rounded-xl mt-8 border border-blue-200">
                    ...
                    <p class="text-xs text-gray-500">Tunjukkan nomor ini saat presensi di lokasi acara.</p>
                </div>

                <div class="mt-8 text-center">
                    <p class="mb-4 text-gray-600">Simpan tiket ini dengan cara screenshot atau unduh sebagai PDF.</p>
                    <a href="{{ route('ticket.download', $attendee->token) }}" class="w-full md:w-auto inline-block bg-gray-900 text-white font-bold py-3 px-8 rounded-xl hover:bg-gray-700 transition-all duration-300 shadow-lg">
